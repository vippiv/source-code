...
jQuery.extend( {
	...
	isPlainObject: function( obj ) {
		...
		// 英：Must be an Object.
		// 中：必须是一个对象
		// 英：Because of IE, we also have to check the presence of the constructor property.
		// 中：由于存在IE，我们必须检测constructor属性
		// 英：Make sure that DOM nodes and window objects don't pass through, as well
		// 中：确保DOM节点和window对象无法通过检测,typeof node返回的也是object
...
var acceptData = function( elem ) {
	...
	//1和9之外的节点都不允许在其上扩展数据，直接返回false，1代表element，9代表document
	return nodeType !== 1 && nodeType !== 9 ?
		false :

		// Nodes accept data unless otherwise specified; rejection can be conditional
		//如果节点是applet，embed则返回false，这两个节点不允许扩展数据
		//flash object节点，只有其classid符合要求才能扩展数据，具体classid是什么，看noData对象
