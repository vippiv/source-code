...
+function ($) {
  ...
  // ============================================================
// 检测当前浏览器是否支持transitionend以及支持哪种前缀的transitionend，如果不支持直接返回false
  function transitionEnd() {
    ...
    for (var name in transEndEventNames) {
      // 如果存在这个属性返回值是一个空字符串而不是undefined
  ...
  // 定义实例方法emulateTransitionEnd，
  $.fn.emulateTransitionEnd = function (duration) {
    var called = false
    // this指向jQuery实例对象
    var $el = this
    // 绑定自定义的bsTransitionEnd事件，执行该事件就更改called的值
    $(this).one('bsTransitionEnd', function () { called = true })
    // 根据called的值触发特定的transitionend事件
